...
export default function Dashboard({ navigation }) {
  ...
  return (
    <ScrollView style={tw`flex-1 w-[95%] mx-auto`}>
      <Text style={tw`text-lg font-bold my-2`}>Check Nearby Facilities</Text>
      <Map />
      <Text style={tw`text-lg font-bold my-2`}>Latest Waste Management Related Information</Text>
    </ScrollView>
  )
}