...
export default function Dashboard({ navigation }) {
  ...
  // Fetch oil cost info
  useEffect(() => {
    async function getOilStats() {
      // Fetch oil cost info from the server
    }
    getOilStats();
  }, []);
  ...
  useEffect(() => {
    async function getVehicleStats() {
      // Fetch vehicle info from the server
    }
    getVehicleStats();
  }, []);
  ...
  // Fetch STS info
  useEffect(() => {
    async function getSTSStats() {
      // Fetch STS info from the server
    }
    getSTSStats();
  }, []);
