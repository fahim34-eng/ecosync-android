...
import { View, Text, Pressable, TextInput, KeyboardAvoidingView, TouchableWithoutFeedback, Keyboard, ActivityIndicator, Image } from "react-native";
  ...
  return (
    ...
    >
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <ScrollView style={tw`mx-5 my-auto`}>
