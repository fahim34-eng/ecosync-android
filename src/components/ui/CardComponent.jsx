...
const CardComponent = ({ issue }) => (
  <Card style={{ marginVertical : 10, marginHorizontal : 5}}>
    ...
    <Card.Content>
      <Text style={tw`my-2 text-md`} variant="titleLarge">Topic :   <Text style={tw`text-gray-500`}>{issue.type}</Text></Text>
      <Text style={tw`my-2 text-md`} variant="bodyMedium">{issue.description}</Text>
    </Card.Content>
